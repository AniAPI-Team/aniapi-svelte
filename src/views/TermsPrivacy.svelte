...
<main>
  ...
  <div class="section">
    <p>
      The AniApi website located at www.aniapi.com is a copyrighted work
  ...
  <h1 style="margin-top:48px">Privacy Policy</h1>
  <div class="section">
    <p>
      At AniAPI, accessible from www.aniapi.com, one of our main priorities is
  ...
  <div class="section">
    <p>
      AniAPI follows a standard procedure of using log files. These files log
  ...
  <div class="section">
    ...
    <p>
      Note that AniAPI has no access to or control over these cookies that are
  ...
  <div class="section">
    <p>
      AniAPI's Privacy Policy does not apply to other advertisers or websites.
  ...
  <div class="section">
    ...
    <p>
      AniAPI does not knowingly collect any Personal Identifiable Information
